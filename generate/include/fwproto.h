 ...
 *
 * $Id: fwproto.h 1.39 1995/03/29 16:42:56 sam Exp $
 * $Locker: sam $
 *
...
void BR_PUBLIC_ENTRY BrPixelmapPlot(br_pixelmap *dst,br_int_16 x,br_int_16 y,br_uint_32 colour);
...
br_pixelmap * BR_PUBLIC_ENTRY BrPixelmapDoubleBuffer(br_pixelmap *dst,br_pixelmap *src);
 ...
 * Error generation
 */
void BR_PUBLIC_ENTRY BrError(char *s,...);
 ...
 * Set new handlers
 */
br_errorhandler * BR_PUBLIC_ENTRY BrErrorHandlerSet(br_errorhandler *neweh);
